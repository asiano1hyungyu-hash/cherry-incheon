...
// Generate 48x48 cherrylogo.png (Cherry Red/Pink background)
const cherrylogoBuf = createPngBuffer(48, 48, 229, 56, 59);

// Generate 64x64 favicon.png
const faviconBuf = createPngBuffer(64, 64, 229, 56, 59);

// Generate 600x600 incheonog.png (Cherry Soft Warm Red/Gold Gradient)
const incheonOgBuf = createPngBuffer(600, 600, 230, 40, 80);

// Generate 800x420 og-image.png (Cherry Soft Gradient background)
...
fs.writeFileSync('./cherrylogo.png', cherrylogoBuf);
fs.writeFileSync('./public/cherrylogo.png', cherrylogoBuf);

fs.writeFileSync('./favicon.png', faviconBuf);
fs.writeFileSync('./public/favicon.png', faviconBuf);

fs.writeFileSync('./incheonog.png', incheonOgBuf);
fs.writeFileSync('./public/incheonog.png', incheonOgBuf);

fs.writeFileSync('./og-image.png', ogBuf);
fs.writeFileSync('./public/og-image.png', ogBuf);

console.log('Successfully generated cherrylogo.png, incheonog.png, favicon.png and og-image.png in root and public!');
